...
<head lang="ru">
    <meta charset="UTF-8">
    <title>Мой знаменитый блог</title>
    ...
    <nav id="header-nav">
        <div id="nav-menu">
            <ul id="nav-menu-list">
                ...
                <li class="nav-menu-item"><a href="/stuff.html">Поделки</a></li>
                <li class="nav-menu-item"><a href="/accounts.html">Аккаунты</a></li>
                <li class="nav-menu-item active"><a>Блог</a></li>
            </ul>
        </div>
    </nav>
</header>
...
<section id="summary">
    <div class="content">
        <h1>Мой знаменитый, ещё не запустившийся, блог.</h1>
        <p>Скоро запуск.</p>
    </div>
</section>
<div class="header-delimeter"></div>
