<?php
//echo SyntaxHighlight::process($code);
...
TNN;
//file_put_contents(__DIR__ . '/code.txt', SyntaxHighlight::process($code));
//file_put_contents(__DIR__ . '/code.txt', highlight_string($code, true));
